...
pub fn get_strategy_bounds(strategy_name: &str) -> Vec<ParamBounds> {
    ...
    match strategy_name.as_str() {
        ...
        // --------------------------------------------------------------------
        // Phase 12.7: Multi-Indicator Strategies
        // --------------------------------------------------------------------
        "TrendMeanRev" => vec![
            ParamBounds::new("ema_fast", 5.0, 30.0, 5.0),
            ParamBounds::new("ema_slow", 20.0, 100.0, 10.0),
            ParamBounds::new("rsi_period", 7.0, 21.0, 7.0),
            ParamBounds::new("rsi_oversold", 20.0, 35.0, 5.0),
            ParamBounds::new("rsi_overbought", 65.0, 80.0, 5.0),
            ParamBounds::new("take_profit", 2.0, 10.0, 2.0),
            ParamBounds::new("stop_loss", 2.0, 10.0, 2.0),
        ],
        "MACDRSICombo" => vec![
            ParamBounds::new("macd_fast", 8.0, 15.0, 2.0),
            ParamBounds::new("macd_slow", 20.0, 30.0, 5.0),
            ParamBounds::new("macd_signal", 7.0, 12.0, 2.0),
            ParamBounds::new("rsi_period", 10.0, 20.0, 5.0),
            ParamBounds::new("rsi_overbought", 65.0, 80.0, 5.0),
            ParamBounds::new("rsi_oversold", 20.0, 35.0, 5.0),
            ParamBounds::new("take_profit", 2.0, 10.0, 2.0),
            ParamBounds::new("stop_loss", 2.0, 10.0, 2.0),
        ...
        "AdaptiveCombo" => vec![
            ...
            ParamBounds::new("rsi_overbought", 65.0, 80.0, 5.0),
            ParamBounds::new("rsi_oversold", 20.0, 35.0, 5.0),
            ParamBounds::new("performance_lookback", 5.0, 20.0, 5.0),
            ParamBounds::new("min_weight", 0.05, 0.2, 0.05),
            ParamBounds::new("take_profit", 2.0, 10.0, 2.0),
            ParamBounds::new("stop_loss", 2.0, 10.0, 2.0),
        ],
        "ConfidenceWeighted" => vec![
            ParamBounds::new("ema_fast", 5.0, 30.0, 5.0),
            ParamBounds::new("ema_slow", 20.0, 100.0, 10.0),
            ParamBounds::new("macd_fast", 8.0, 15.0, 2.0),
            ParamBounds::new("macd_slow", 20.0, 30.0, 5.0),
            ...
            ParamBounds::new("rsi_overbought", 65.0, 80.0, 5.0),
            ParamBounds::new("rsi_oversold", 20.0, 35.0, 5.0),
            ParamBounds::new("min_confidence", 0.3, 0.7, 0.1),
            ParamBounds::new("take_profit", 2.0, 10.0, 2.0),
            ParamBounds::new("stop_loss", 2.0, 10.0, 2.0),
        ],
        "EnsembleWeighted" => vec![
            ParamBounds::new("performance_lookback", 5.0, 20.0, 5.0),
            ParamBounds::new("min_weight", 0.05, 0.2, 0.05),
            ParamBounds::new("weight_smoothing", 0.2, 0.5, 0.1),
            ParamBounds::new("take_profit", 2.0, 10.0, 2.0),
            ParamBounds::new("stop_loss", 2.0, 10.0, 2.0),
        ],
        "MLEnhanced" => vec![
            ...
            ParamBounds::new("trend_weight", 0.2, 0.4, 0.05),
            ParamBounds::new("momentum_weight", 0.25, 0.45, 0.05),
            ParamBounds::new("meanrev_weight", 0.15, 0.25, 0.05),
            ParamBounds::new("volatility_weight", 0.1, 0.2, 0.05),
            ParamBounds::new("min_prediction_score", 0.5, 0.7, 0.05),
            ParamBounds::new("take_profit", 2.0, 10.0, 2.0),
            ParamBounds::new("stop_loss", 2.0, 10.0, 2.0),
        ],
        "RegimeSwitching" => vec![
            ...
            ParamBounds::new("ema_slow", 20.0, 100.0, 10.0),
            ParamBounds::new("atr_period", 10.0, 20.0, 2.0),
            ParamBounds::new("trend_threshold", 0.01, 0.03, 0.005),
            ParamBounds::new("volatility_threshold", 0.02, 0.04, 0.005),
            ParamBounds::new("rsi_period", 10.0, 20.0, 5.0),
            ParamBounds::new("rsi_oversold", 20.0, 35.0, 5.0),
            ParamBounds::new("rsi_overbought", 65.0, 80.0, 5.0),
            ParamBounds::new("take_profit", 2.0, 10.0, 2.0),
        ...
        // --------------------------------------------------------------------
        // Phase 12.6: Sentiment-Based Strategies
        // --------------------------------------------------------------------
        "Divergence" => vec![
            ParamBounds::new("price_lookback", 15.0, 30.0, 5.0),
            ParamBounds::new("sentiment_lookback", 10.0, 20.0, 5.0),
            ParamBounds::new("price_trend_threshold", 2.0, 5.0, 0.5),
            ParamBounds::new("sentiment_trend_threshold", 3.0, 7.0, 1.0),
            ParamBounds::new("min_divergence_bars", 2.0, 5.0, 1.0),
            ParamBounds::new("take_profit", 3.0, 10.0, 2.0),
            ParamBounds::new("stop_loss", 2.0, 5.0, 1.0),
        ],
        "RegimeSentiment" => vec![
            ParamBounds::new("regime_lookback", 15.0, 30.0, 5.0),
            ParamBounds::new("sentiment_lookback", 10.0, 20.0, 5.0),
            ParamBounds::new("trend_threshold", 40.0, 60.0, 10.0),
            ParamBounds::new("volatility_threshold", 1.5, 3.0, 0.5),
            ParamBounds::new("bull_bullish_threshold", 55.0, 65.0, 5.0),
            ParamBounds::new("bear_bullish_threshold", 35.0, 45.0, 5.0),
            ParamBounds::new("sideways_bullish_threshold", 45.0, 55.0, 5.0),
            ParamBounds::new("momentum_threshold", 3.0, 7.0, 1.0),
        ],
        "SentimentMomentum" => vec![
            ParamBounds::new("lookback_period", 10.0, 20.0, 5.0),
            ParamBounds::new("bullish_threshold", 25.0, 35.0, 5.0),
            ParamBounds::new("bearish_threshold", 65.0, 75.0, 5.0),
            ParamBounds::new("momentum_threshold", 3.0, 7.0, 1.0),
            ParamBounds::new("volume_confirmation", 1.0, 2.0, 0.2),
        ],
